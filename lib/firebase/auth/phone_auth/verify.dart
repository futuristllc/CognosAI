...
class PhoneAuthVerify extends StatefulWidget {
  ...
  final String appName = "Verify OTP";
  ...
  Widget _getColumnBody() => Column(
        children: <Widget>[
          ...
          Padding(
            ...
            child: Image.asset('assets/images/brand.png', height: 140, width: 140,)
          ),
          // AppName:
          Text(widget.appName,
...
//    _showSnackBar(phoneAuthDataProvider.message);
  ...
  onVerified() async {
    ...
    Navigator.of(context)
        .pushReplacement(MaterialPageRoute(builder: (BuildContext context) => UserDetails()));
  }
